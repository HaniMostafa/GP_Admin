...
namespace Project.DataAccess.Data { 
    ...
    [Migration("20240322055135_AddIdentityTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GP_Admin.Models.Admin", b =>
                {
            ...
            modelBuilder.Entity("GP_Admin.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("GP_Admin.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("GP_Admin.Models.FailedJob", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint unsigned")
            ...
            modelBuilder.Entity("GP_Admin.Models.Grade", b =>
                {
                    b.Property<int>("StudentId")
                        .HasColumnType("int")
                        .HasColumnName("StudentID");
            ...
            modelBuilder.Entity("GP_Admin.Models.Material", b =>
                {
                    b.Property<ulong>("MyRowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint unsigned")
            ...
            modelBuilder.Entity("GP_Admin.Models.Migration", b =>
                {
                    b.Property<uint>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GP_Admin.Models.PasswordResetToken", b =>
                {
                    b.Property<string>("Email")
                        .HasColumnType("varchar(255)")
                        .HasColumnName("email");
            ...
            modelBuilder.Entity("GP_Admin.Models.PersonalAccessToken", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint unsigned")
            ...
            modelBuilder.Entity("GP_Admin.Models.Professor", b =>
                {
            ...
            modelBuilder.Entity("GP_Admin.Models.ProfessorCourse", b =>
                {
                    b.Property<int>("ProfessorId")
                        .HasColumnType("int")
                        .HasColumnName("ProfessorID");
            ...
            modelBuilder.Entity("GP_Admin.Models.Requirement", b =>
                {
                    b.Property<string>("CourseId")
                        .HasColumnType("varchar(255)")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("GP_Admin.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GP_Admin.Models.Enrollment", b =>
                {
                    b.HasOne("GP_Admin.Models.Course", "Course")
                        .WithMany("Enrollments")
                        .HasForeignKey("CourseId")
                        .IsRequired()
                        .HasConstraintName("enrollments_courseid_foreign");

                    b.HasOne("GP_Admin.Models.User", "Student")
                        .WithMany("Enrollments")
            ...
            modelBuilder.Entity("GP_Admin.Models.ProfessorCourse", b =>
                {
                    ...
                    b.HasOne("GP_Admin.Models.Professor", "Professor")
                        .WithOne("ProfessorCourse")
                        .HasForeignKey("GP_Admin.Models.ProfessorCourse", "ProfessorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("GP_Admin.Models.Requirement", b =>
                {
                    ...
                    b.HasOne("GP_Admin.Models.Course", "Requirement1Navigation")
